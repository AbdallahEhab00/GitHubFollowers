...
//  GitHubFollowers
//
//  Created by Abdallah Ehab on 31/05/2022.
//
...
class GFUserInfoHeaderVC: UIViewController {
    ...
    func configureUI(){
        ...
        locationImageView.image     = UIImage(systemName: Constant.location)
    ...
    func layoutUI(){
        ...
        NSLayoutConstraint.activate([
            ...
            locationLabel.centerYAnchor.constraint(equalTo: locationImageView.centerYAnchor,constant: 2),
